...
function AddNewM() {
    document.getElementById('newMBlock').style.display = 'block';
}
...
function deleteA(rowIndex) {
    ...
    console.log(Ukey);
    var r = confirm("Are you sure you want to delete memo?");
    if (r == true) {
...
function editA(rowIndex) {
    document.getElementById('editMBlock').style.display = 'block';
    var Ukey = an[rowIndex];
...
function showmemo() {
    ...
    document.getElementById("memospan").style.opacity = "1";
...
function showcs() {
    ...
    document.getElementById("data3").style.display = "none";
    document.getElementById("data4").style.display = "none";
    document.getElementById("memospan").style.opacity = ".8";
